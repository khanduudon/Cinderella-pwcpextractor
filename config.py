...
OWNER = int(os.environ.get("OWNER", "8727689182"))

AUTH_USER = os.environ.get(
    "AUTH_USERS",
    "8727689182,6446087354,8480660521,8680968748,8446475678,7988815969,8429278856,7920113547,8723278238,8715662594,8838086114").split(',')
...
LOG_CHANNEL = (os.environ.get("LOG_CHANNEL", "-1004301546823"))
